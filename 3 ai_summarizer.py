...
EXCLUDED_STEPS_BY_PRODUCT = { # ขั้นตอนที่ไม่นำมาคิดคะแนนสำหรับแต่ละผลิตภัณฑ์
    "debit_card": {6}  # ขั้นตอนที่ไม่คิดคะแนนสำหรับ debit_card
}
...
def build_comprehensive_prompt(transcript: str, criteria_data: Dict[str, Any]) -> str:
    ...
    prompt = f""" "คุณคือผู้ตรวจสอบคุณภาพ (QA) ที่เชี่ยวชาญ วิเคราะห์บทสนทนาต่อไปนี้และประเมินตามเกณฑ์ที่กำหนดอย่างละเอียด
